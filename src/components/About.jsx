...
const About = () => {
  return (
    <div id="about" className="min-h-screen m-10 md:mt-16 mt-8 md:mx-24">
      <h2 className="text-center md:text-6xl text-4xl text-indigo-900 drop-shadow-lg md:mb-20 mb-8">
        Details
      </h2>
