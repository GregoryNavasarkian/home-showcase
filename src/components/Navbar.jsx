...
const Navbar = () => {
  ...
  return (
    <div className="shadow-md w-full fixed top-0 left-0 z-10 bg-indigo-100">
      <div className="md:flex items-center justify-between py-4 md:px-14 px-7">
        ...
        <ul className={`md:flex flex-shrink-0 md:items-center md:pb-0 pb-12 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 ${open
